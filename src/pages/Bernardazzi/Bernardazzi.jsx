  ...
  return (
    <div className={css.archSection}>
      ...
      <div className={css.biographi}>
        ...
        <p>
          Семейство Бернардацци из Памбио (в Тичино) обосновалось на юге России
          при Александре I. В 1843 году определён в младшие классы Строительного
          ...
          Почти 30 лет был городским архитектором Кишинёва. С 1875 года —
          Почётный потомственный гражданин. В 1883 году переехал в Одессу, но
          продолжал проектировать и для Бессарабии, позднее работал в
          Новороссийском университете.
        </p>
        <p>
          Бернардацци был приверженцем классицизма, затем неоклассицизма, в то
          же время он тяготел к стилизации итальянского ренессанса с элементами
          готики.
        </p>
        <p>
          Александр Бернардацци умер в командировке в Фастове под Киевом.
          Согласно завещанию он был похоронен в Кишинёве рядом со своей матерью.
        </p>
      </div>
